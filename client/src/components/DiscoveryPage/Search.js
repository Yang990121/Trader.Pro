...
const LineChartCard = ({ pastDataPeriod, stockInfo, duration }) => {
	return (
		<Grid item xs={100} sm={100} style={{ minHeight: "350px" }}>
			<LineChart
							...
							{JSON.stringify(stockData) != "{}" ? (
								<Item>
									<div>
										...
										/>
										<p>
											Adjusted closing stock price of{" "}
											{stockData.symbol} over the past 1
											month
										</p>
									</div>
								</Item>
								...
								<Item>
									<div>
										...
										<h3 className="Description">
											...
											{stockData.ytdChange}%<br />
										</h3>
										<h3 className="Description">
											<strong>
												Price to Equity Rtio:{" "}
											</strong>
											{stockData.peRatio}%<br />
										</h3>
										<h3 className="Description">
							...
							{JSON.stringify(stockData) != "{}" ? (
								<Item>
									<div>
										...
										<h3>
											if can, can buy how many, if cannot,
											need how much cash to buy
										</h3>
										<br />
